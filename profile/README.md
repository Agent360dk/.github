...
We build tools that let an AI agent use the things you already use - your browser,
your Mac - without asking you to move your work somewhere it can be watched.

Two of them are open source and free.
...
[**agent360.dk**](https://agent360.dk) - the company. We build AI systems for Danish
businesses: the plumbing, not the demo.

[**jesperai.com**](https://jesperai.com) - AI phone agents that handle recruitment
screening and inbound service calls in Danish.
